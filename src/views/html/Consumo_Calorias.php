...
<head>
  ...
  <title>Consumo Alimenticio</title>
              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">¡Vamos a ingresar tu consumo alimenticio!</h5>
                    <small class="text-muted float-end">Procura usar aplicaciones o llevar un monitoreo de tu dieta para usar correctamente el aplicativo</small>
                  </div>
                  <div class="card-body">
                    <form>
                      <div class="row mb-3">
