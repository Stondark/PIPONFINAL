              ...
              <!-- Layout Demo -->
                    <div class="d-flex align-items-end row">
                      <div class="card text-center mb-3">
                        <div class="card-body">
                          <h2 class="card-title">Ingresar peso</h2>
                          <p class="mb-1">Tu peso actual:</p>
                          <h4 class="card-title">{Peso}</h4>
                          <p class="mb-1">En base a tu estatura, tu peso ideal sería de: {Peso}</p>
                          <div class="text-light  fw-semibold">¿Cómo pesarme?</div>
